...
global $db, $conf;
	...
	if($mbox === false) {
		print "Connexion impossible  $host, $mailbox, $login";
		return false;
	}
	else{
	...
	if($info === false) {
		print "Erreur imap_check<br />"; return false;
	}
	...
	if($point_to_start<1) $point_to_start = 1;	
...
function getmsg($mbox,$mid) {
	...
	return array($plainmsg, $htmlmsg, $attachments);
}
